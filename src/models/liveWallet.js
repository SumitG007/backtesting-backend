...
const liveWalletSchema = new mongoose.Schema(
  {
    ...
    strategy13EngineSettings: {
      ...
      targetPoints: { type: Number, default: 8 },
      stopLossPoints: { type: Number, default: 10 },
      targetPointsIndex: { type: Number, default: 8 },
      stopLossPointsIndex: { type: Number, default: 10 },
      targetPointsStock: { type: Number, default: 3 },
      stopLossPointsStock: { type: Number, default: 5 },
      minOiRatio: { type: Number, default: 1.5 },
      proximityPointsIndex: { type: Number, default: 15 },
      proximityPctStock: { type: Number, default: 0.35 },
      maxTradesPerDay: { type: Number, default: 8 },
      cooldownMinutes: { type: Number, default: 3 },
      perTradeCost: { type: Number, default: 100 },
      confirmCandleIndex: { type: Boolean, default: true },
      confirmCandleStock: { type: Boolean, default: false },
      confirmCandleInterval: { type: String, default: '5' },
      confirmEntryWindowMinutes: { type: Number, default: 2 },
      universe: { type: [String], default: undefined },
      universeExplicit: { type: Boolean, default: false },
    },
    strategy3OrHistory: {
